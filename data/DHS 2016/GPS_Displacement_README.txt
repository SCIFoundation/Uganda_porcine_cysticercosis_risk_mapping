Dataset: Uganda 2016 DHS (UGGE71FL)
Displacement Restriction: Admin 2 (Subcounty)
...
Restricted to Subcounty:
The displacement is restricted so that the points stay within the country, within the DHS survey region, and within
the Subcounties.Therefore, the displaced cluster's coordinates are located within the same Country, Region,
and Subcounty areas as the undisplaced cluster.
